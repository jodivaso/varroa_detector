...
"""
Obtained from: https://github.com/sovit-123/fasterrcnn-pytorch-training-pipeline/blob/main/models/fasterrcnn_vitdet.py
...
from utils_backbones import _assert_strides_are_log2_contiguous
...
def create_VIT_model(num_classes=81, pretrained=True, coco_model=False):
    # Base
